...
enum LOBBY { LOBBY_NONE = 1001, INTRO1, INTRO2, INTRO3, START_LOBBY, MAIN_LOBBY, MAIN_LOBBY2, MAIN_LOBBY3, MAIN_LOBBY4, CREATE_PROFILE_LOBBY, GAME_QUIT,SELECT_MAP_LOBBY, SELECT_CAR_LOBBY, CREATE_PROFILE_LOBBY2};
