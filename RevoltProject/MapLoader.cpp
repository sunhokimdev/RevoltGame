...
//void MapLoader::Load(LPD3DXMESH pMesh, std::vector<MtlTex*>	m_vecObjMtlTex, char * szFolder, const char * szFile)
//{
//
//	FILE* fp;
//	int offsetIndex = 0;
...
//			pMesh = load.LoadMesh(m_vecObjMtlTex, (tFolder.c_str()), tStr.c_str());
//		}
//	}
//}
