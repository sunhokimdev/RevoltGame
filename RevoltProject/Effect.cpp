...
void Effect::SetTexture(char * szFullPath)
{
...
void Effect::SetFrameTexture(char * szFullPath, int MaxFrameX, int MaxFrameY)
{
	D3DXIMAGE_INFO stImageInfo;
...
void Effect::SetEffectType(int TypeNum)
{
	if (TypeNum == 1)
		m_effectType = WATER;
}
...
void Effect::BillboardRender(LPD3DXSPRITE Sprite,
